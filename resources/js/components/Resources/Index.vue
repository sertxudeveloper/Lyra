  ...
  <div class="xl:p-4">
    ...
    <div v-if="resources?.data?.length" class="bg-white flex flex-col max-w-0 min-w-full rounded-lg shadow w-full">
      <div class="flex items-center justify-between h-9 m-4">
        ...
        <div class="flex items-center gap-x-4 h-full">
          <!-- Filter tool -->
          <button class="bg-gray-200 h-full flex focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 items-center px-3 rounded text-gray-700" @click="getResources">
          ...
          <!-- Filter tool -->
          <button class="bg-gray-200 cursor-pointer flex focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 gap-1.5 gap-x-2 h-full items-center px-3 rounded text-gray-700">
          ...
          <!-- New resource button -->
          <router-link class="bg-blue-600 flex focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 h-full items-center px-3 rounded"
        ...
        <table class="w-full border-b border-gray-200">
          ...
          <tr v-for="resource in resources.data">
            ...
            <td class="flex px-2 py-2.5 text-gray-400 whitespace-nowrap">
              <router-link :to="{ name: 'resource-show', params: { resourceName: $route.params.resourceName, resourceId: resource.key } }"
                           class="h-9 hover:text-blue-500 p-2 w-9">
              ...
              <router-link :to="{ name: 'resource-edit', params: { resourceName: $route.params.resourceName, resourceId: resource.key } }"
                           class="h-9 hover:text-blue-500 p-2.5 w-9">
