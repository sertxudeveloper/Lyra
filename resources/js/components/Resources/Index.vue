      ...
      <div class="flex items-center justify-between h-9 m-4">
        ...
        <div class="flex items-center gap-x-4 h-full">
          ...
          <button class="bg-gray-200 h-full flex focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 items-center px-3 rounded text-gray-700"
                  @click="getResources({ notify: true })">
      ...
      <div class="overflow-x-auto">
        <table class="w-full border-b border-gray-200">
          ...
          <tr class="uppercase text-left text-xs tracking-wider text-gray-500">
            ...
            <TableHeader :resource="resources.data" @updated="getResources"></TableHeader>
            <th scope="col" class="px-6 py-4">&nbsp;</th>
          </tr>
          </thead>
          ...
          <tr v-for="resource in resources.data">
            ...
            <td class="flex px-2 py-2.5 text-gray-400 whitespace-nowrap">
              ...
              <button @click="remove(resource.key)"
