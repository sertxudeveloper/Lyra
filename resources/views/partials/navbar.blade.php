...
<div class="bg-white flex-shrink-0 h-16 inline-flex shadow w-full z-0">
    ...
    <div class="w-full flex text-gray-500">
        ...
        <div class="text-gray-700 w-full h-full py-3">
            <input type="search" name="search" placeholder="Search..." class="border-0 h-full outline-none placeholder-gray-500 w-full focus:ring-0">
        </div>
    </div>
